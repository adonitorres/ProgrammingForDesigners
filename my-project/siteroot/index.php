...
?>
  ...
  <main>
    ...
    <section id="about" class="about">
      ...
      <img class="hero-about" src="images/about-hero-mb.jpg" alt="view of table with dice and character sheets">
    ...
    <section id="browse" class="browse">
      ...
      <ul class="flex">
        <li class="dgames"><a href=""><span>Browse<br>Games</span></a></li>
        <li class="dgms"><a href=""><span>Browse<br>GMs</span></a></li>
      </ul>
    </section>
    <section id="contact" class="contact">
      <h3>Contact Us</h3>
      <p>Join our communties to stay in touch with the latest events and discussion with other local players and GMs!</p>
      <form method="post" action="path to processor">
        <div class="fname">
        ...
        <div class="policy">
          <p>By clicking Sign Up, you agree to our <a href="">Terms</a>, <a href="">Data Policy</a> and <a href="">Cookies Policy</a>. You may receive SMS Notifications from us and can opt out any time.</p>
        </div>
